...
func (o *ShakeWorksURL) Build() (*url.URL, error) {
	...
	lineQ := swag.FormatInt64(o.Line)
	if lineQ != "" {
		qs.Set("line", lineQ)
	}

	var maxLinesQ string
	if o.MaxLines != nil {
		maxLinesQ = swag.FormatInt64(*o.MaxLines)
	}
	if maxLinesQ != "" {
		qs.Set("maxLines", maxLinesQ)
	}
...
func (o *ShakeWorksURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ShakeWorksURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ShakeWorksURL")
	}
